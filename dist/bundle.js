...
const config = { // Создаем объект конфигурации, который позволит нам работать с переменными
  key: '123456'
}
...
// CONCATENATED MODULE: ./src/modules/header.component.js
 // Мы не указали полного пути, т.к. вебпак сам понимает, что нужно идти в папку node modules и искать там жуйквери
